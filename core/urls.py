...
urlpatterns = [
    ...
    url(r'^departments/$', report.departments_report_list_view, name='departments_report_list_view'),
    url(r'^departments/(?P<department_id>\d+)/$', report.department_users_list_view, name='department_users_list_view'),
    url(r'^departments/(?P<department_id>\d+)/(?P<user_id>\d+)/$', report.department_user_examinations_list_view, name='department_user_examinations_list_view'),
    ...
    url(r'^adm/departments/(?P<department_id>\d+)/$', department.department_create_or_update_view, name='department_update_view'),
    url(r'^adm/department/$', department.department_create_or_update_view, name='department_create_view'),
    url(r'^adm/$', department.department_list_view, name='department_list_view'),

    url(r'^doc/$', doc.doc, name='doc'),
]